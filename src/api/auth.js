...
export const verifyEmail = async data => {
    ...
    let url = process.env.REACT_APP_API_URL + '/api/auth/verify';
    let csrfUrl = process.env.REACT_APP_API_URL + '/sanctum/csrf-cookie';
...
export const forgotPassword = async data => {
    ...
    let url = process.env.REACT_APP_API_URL + '/api/auth/forgot-password';
    let csrfUrl = process.env.REACT_APP_API_URL + '/sanctum/csrf-cookie';
...
export const resetPassword = async data => {
    ...
    let url = process.env.REACT_APP_API_URL + '/api/auth/reset-password';
    let csrfUrl = process.env.REACT_APP_API_URL + '/sanctum/csrf-cookie';
