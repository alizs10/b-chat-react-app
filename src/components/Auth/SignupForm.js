...
function SignupForm({ setLoginFormVisibility, setSignupFormVisibility }) {
    ...
    const { errors, username, password, setUsername, setPassword, handleRegister, email, setEmail, passwordConfirmation, setPasswordConfirmation, handleCheckUsername } = useContext(AuthContext)
