...
function VerificationCodeForm() {
    ...
    const handleVerificationCode = (value, position) => {
    ...
    <form className='flex-center flex-col gap-y-2'>
        ...
        <div className='w-4/5 md:w-3/5 lg:w-2/5 grid grid-cols-6 gap-x-2'>
            ...
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 0)}
                value={vCodeArr[0]}
                ref={vcodeRef0}
            />
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 1)}
                value={vCodeArr[1]}
                ref={vcodeRef1}
            />
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 2)}
                value={vCodeArr[2]}
                ref={vcodeRef2}
            />
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 3)}
                value={vCodeArr[3]}
                ref={vcodeRef3}
            />
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 4)}
                value={vCodeArr[4]}
                ref={vcodeRef4}
            />
            <input type="text" className='col-span-1 border border-gray-200 text-center p-2 md:p-3 focus:outline-none input-focus bg-transparent rounded-corners text-gray-800'
                onChange={e => handleVerificationCode(e.target.value, 5)}
                value={vCodeArr[5]}
                ref={vcodeRef5}
            />
