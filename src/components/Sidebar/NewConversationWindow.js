...
function NewConversationWindow({ handleClose }) {
  return (
    <div
      ...
      className='z-50  w-4/5 md:w-3/5 p-3 rounded-corners flex-col gap-y-4 bg-white shadow-lg'>
      ...
      <div className="mt-4 w-full grid grid-cols-9 gap-y-2 gap-x-4">
        ...
        <div className='col-span-2'>
          <button className='btn-hover w-full h-full p-3 bg-[#4361EE] text-white text-sm rounded-corners'>
            Start Conversation
          </button>
        </div>
      </div>
